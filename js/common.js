            ...
            callbacks: {
                open: function() {
                    ...
                    $(window).resize(function() {
                        ...
                        var popup_h = parseInt($('.mfp-content .mfp-os-popup-content').height() - $('.details h5').height(), 10);
                        ...
                        if(new_padd < 500){$('.mfp-content .mfp-os-popup-content .video-container').css("padding-bottom", new_padd);} 
                    });
                },
