    ...
    d.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(a) {
            ...
            if (b.scrollParent[0] != document && b.scrollParent[0].tagName != "HTML") {
                ...
                if (a.pageY - b.overflowOffset.top < c.scrollSensitivity) b.scrollParent[0].scrollTop = f = b.scrollParent[0].scrollTop -
                    c.scrollSpeed;
                if (!c.axis || c.axis != "y")
                ...
                if (a.pageX - b.overflowOffset.left < c.scrollSensitivity) b.scrollParent[0].scrollLeft = f = b.scrollParent[0].scrollLeft - c.scrollSpeed
            } else {
                if (!c.axis || c.axis != "x")
...
(function(d, G) {
    ...
    d.extend(K.prototype, {
        ...
        parseDate: function(a, b, c) {
            ...
            if (c < 100) c += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (c <= e ? 0 : -100);
            if (u > -1) {
                j = 1;
                l = u;
                do {
    ...
    f.extend(f.easing, {
        ...
        easeInOutElastic: function(c, a, b, d, e) {
            ...
            if (h < Math.abs(d)) {
                ...
                h); if (a < 1) return -0.5 * h * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * e - c) * 2 * Math.PI / g) + b;
